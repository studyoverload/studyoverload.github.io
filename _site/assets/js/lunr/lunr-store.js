var store = [{
        ...
        "teaser": "/assets/images#%20path%20of%20fallback%20teaser%20image,%20e.g.%20%22/assets/images/500x300.png%22"
      },{
        "title": "無程式經驗，如何在GitHub用Jekyll建Blog (設置篇）",
        "excerpt":"本文寫給毫無程式經驗，想要用 Jekyll 在 GitHub 建 Blog 的新手，內含步驟文和實踐心得。 部落格之始 如果你想要建部落格，有滿多人會從現有的部落格平台（痞客邦、Medium）開始，只要註冊就可以開始發布內容了。 如果你想要擁有網站的自主權又不想碰太多程式編寫的部分，可以選擇 Wordpress.org ，眾多外掛任你挑，掌握SEO數據和資料庫。網路上有很多教學文，註冊後購買主機 (hosting) 和域名 (domain)，就建好了。我另一個部落格也是用 Wordpress 建置，有興趣的話，也許之後可以寫教學心得文。 如果你想要開始學寫程式，建立自己的 GitHub Page 是滿好的開始，可以紀錄學習的過程，也能夠為其他有相似問題的人提供解法。我個人而言，除了想要練習寫文章、學程式之外，更大的原因是不想花錢買主機和個人網域，就開始了簡單設置個人 Blog 的念頭。其實我連用 Wordpress 架的另一個網站也是用 GitHub Page 的方式，沒有去買主機。 Jekyll 是什麼？ Jekyll 是一個簡單的靜態網站生成器 (static site generator)，它是由 Ruby 編寫而成，將純文本文檔（Markdown, HMTL, CSS) 轉換成靜態網站。他很簡單直觀，適合初學者使用。網路上有滿多參考文章，和佈景主題可以選，跟著步驟做，很快就可以做出來了。最吸引人的地方是，Jekyll 可以和 GitHub Page 搭配，做出免費美觀的網頁。 Github 是什麼？ GitHub 是公開的原始碼代管平台，你可以上傳專案，紀錄自己寫過什麼程式、對別人的開發做了什麼貢獻。通常工程師要投履歷的時候都會附上自己的 GitHub 頁面，展現過往的參與和 side...","categories": [],
        "tags": ["GitHub Pages","Jekyll","Blog"],
        "url": "/jekyll-github-setup/",
        "teaser": "/assets/images#%20path%20of%20fallback%20teaser%20image,%20e.g.%20%22/assets/images/500x300.png%22"
      },{
        "title": "如果重來，我會如何準備學測 (目標設定篇)",
        "excerpt":"每年五六月會有滿多學長姐回到高中，向升高三的同學分享學測的準備心得。藉這個機會，我想聊聊當初我是怎麼準備，有哪些我希望能做得更好。這一系列心得會分成不同面向討論，第一篇是關於目標設定。 My centered text. This is my first level quoting with a citation. Joan Doe Button name This text is rendered in green. Notice: This is an important info notice. 為什麼從目標設定談起？ 回想當年，每個人都忙著向學長姐請教如何提升讀書效率、如何調適心情時，很少人會談談考完試之後會發生什麼事。進大學、大學畢業後、找工作有什麼標準可以衡量嗎？準備考試的時候，我們是為了什麼而做？我們從這一整個過程裡學到了什麼可以應用在往後的人生？ 考生如我沒想這麼多，每天過規律的作息：寫題目、整理筆記、累了小睡、放學跑操場。直到考完試，有學校念了，完成階段性的任務後，才開始想「然後呢？」(What now?) 好像這一切，都是且走且看，難道沒有什麼更深層的意涵嗎？ 缺乏了大局觀思維 (Big Picture Thinking)，我頓時迷茫了起來，意識到「目標」的重要性。 漫無目標的生活，讓人無所適從。 如何設定目標？ 那要怎麼找到目標呢？ 目標可大可小，大至「大學畢業後想做什麼職業、選什麼校系」，小至「每天安排的讀書進度」。 要選什麼職業，對高中生來說太遙遠，很難說以後會做什麽樣的工作。 要選什麼校系，這也要看個人志向和最後分數夠不夠，並非完全在自己的掌握之中。 每天安排的讀書進度，這也要看自己對整個學測的準備規劃而定。 要設定合適的目標要考量的事情太多了，就是要從哪裡著手才好？我需要一個立足點。 1️⃣ 從認識自己開始 老話一句，做任何決定前都要先了解自己。目標設定是非常個人的事情，儘管你收集了許多資料、觀察同學們都做了什麼，終究還是回歸到自己。不論我在這篇文章說了什麼，先沈澱一下，想清楚或是和別人討論後再進行下一步，不要照單全收。（對沒錯，這是免責說明...","categories": [],
        "tags": ["Study","Mindset"],
        "url": "/set-goal/",
        "teaser": "/assets/images#%20path%20of%20fallback%20teaser%20image,%20e.g.%20%22/assets/images/500x300.png%22"
      }]
